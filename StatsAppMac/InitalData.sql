...
insert into ZPARTICIPANT (Z_PK, Z_ENT, Z_OPT, ZMATCH, ZPARTICIPANTSTATISTICS, Z8_PARTICIPANTSTATISTICS, ZPLAYER, ZTEAMPARTICIPANT, ZTEAM) values (3,7,1,2,NULL,NULL,NULL,NULL,1);
insert into ZPARTICIPANT (Z_PK, Z_ENT, Z_OPT, ZMATCH, ZPARTICIPANTSTATISTICS, Z8_PARTICIPANTSTATISTICS, ZPLAYER, ZTEAMPARTICIPANT, ZTEAM) values (4,7,1,2,NULL,NULL,NULL,NULL,7);

-- Match 3 Participants: Old Haileybury Seniors (1) VS Old Xavier Seniors (7)
insert into ZPARTICIPANT (Z_PK, Z_ENT, Z_OPT, ZMATCH, ZPARTICIPANTSTATISTICS, Z8_PARTICIPANTSTATISTICS, ZPLAYER, ZTEAMPARTICIPANT, ZTEAM) values (5,7,1,3,NULL,NULL,NULL,NULL,4);
insert into ZPARTICIPANT (Z_PK, Z_ENT, Z_OPT, ZMATCH, ZPARTICIPANTSTATISTICS, Z8_PARTICIPANTSTATISTICS, ZPLAYER, ZTEAMPARTICIPANT, ZTEAM) values (6,7,1,3,NULL,NULL,NULL,NULL,7);

-- Match 4 Participants: Old Haileybury Seniors (1) VS Old Melbournians Seniors (10)
insert into ZPARTICIPANT (Z_PK, Z_ENT, Z_OPT, ZMATCH, ZPARTICIPANTSTATISTICS, Z8_PARTICIPANTSTATISTICS, ZPLAYER, ZTEAMPARTICIPANT, ZTEAM) values (7,7,1,4,NULL,NULL,NULL,NULL,1);
insert into ZPARTICIPANT (Z_PK, Z_ENT, Z_OPT, ZMATCH, ZPARTICIPANTSTATISTICS, Z8_PARTICIPANTSTATISTICS, ZPLAYER, ZTEAMPARTICIPANT, ZTEAM) values (8,7,1,4,NULL,NULL,NULL,NULL,10);

-- Player Participant in Team Particpant 1
insert into ZPARTICIPANT (Z_PK, Z_ENT, Z_OPT, ZMATCH, ZPARTICIPANTSTATISTICS, Z8_PARTICIPANTSTATISTICS, ZPLAYER, ZTEAMPARTICIPANT, ZTEAM) values (50,6,1,NULL,NULL,1,1,1,NULL);
...
insert into ZUSER (Z_PK, Z_ENT, Z_OPT, ZUSERID, ZGOALS, ZBEHINDS, ZKICKS, ZTACKLES, ZHANDBALLS, ZMARKS, ZUSERNAME, ZLASTNAME, ZFIRSTNAME) values (1,16,1,1,0,0,0,0,0,0,'dmackenz1981@gmail.com','Mackenzie', 'David');
insert into ZUSER (Z_PK, Z_ENT, Z_OPT, ZUSERID, ZGOALS, ZBEHINDS, ZKICKS, ZTACKLES, ZHANDBALLS, ZMARKS, ZUSERNAME, ZLASTNAME, ZFIRSTNAME) values (2,16,1,2,0,0,0,0,0,0,'mkeanie11@gmail.com','Keane', 'Michelle');
insert into ZUSER (Z_PK, Z_ENT, Z_OPT, ZUSERID, ZGOALS, ZBEHINDS, ZKICKS, ZTACKLES, ZHANDBALLS, ZMARKS, ZUSERNAME, ZLASTNAME, ZFIRSTNAME) values (3,16,1,3,0,0,0,0,0,0,'njones@gmail.com','Nathan', 'Jones');
insert into ZUSER (Z_PK, Z_ENT, Z_OPT, ZUSERID, ZGOALS, ZBEHINDS, ZKICKS, ZTACKLES, ZHANDBALLS, ZMARKS, ZUSERNAME, ZLASTNAME, ZFIRSTNAME) values (4,16,1,4,0,0,0,0,0,0,'mjamar@gmail.com','Mark', 'Jamar');
insert into ZUSER (Z_PK, Z_ENT, Z_OPT, ZUSERID, ZGOALS, ZBEHINDS, ZKICKS, ZTACKLES, ZHANDBALLS, ZMARKS, ZUSERNAME, ZLASTNAME, ZFIRSTNAME) values (5,16,1,5,0,0,0,0,0,0,'xav1@gmail.com','Xav1', 'Dude1');
insert into ZUSER (Z_PK, Z_ENT, Z_OPT, ZUSERID, ZGOALS, ZBEHINDS, ZKICKS, ZTACKLES, ZHANDBALLS, ZMARKS, ZUSERNAME, ZLASTNAME, ZFIRSTNAME) values (6,16,1,6,0,0,0,0,0,0,'xav2@gmail.com','Xav2', 'Dude2');
insert into ZUSER (Z_PK, Z_ENT, Z_OPT, ZUSERID, ZGOALS, ZBEHINDS, ZKICKS, ZTACKLES, ZHANDBALLS, ZMARKS, ZUSERNAME, ZLASTNAME, ZFIRSTNAME) values (7,16,1,7,0,0,0,0,0,0,'om1@gmail.com','Om1', 'Dude1');
insert into ZUSER (Z_PK, Z_ENT, Z_OPT, ZUSERID, ZGOALS, ZBEHINDS, ZKICKS, ZTACKLES, ZHANDBALLS, ZMARKS, ZUSERNAME, ZLASTNAME, ZFIRSTNAME) values (8,16,1,8,0,0,0,0,0,0,'om2@gmail.com','Om2', 'Dude2');
insert into ZUSER (Z_PK, Z_ENT, Z_OPT, ZUSERID, ZGOALS, ZBEHINDS, ZKICKS, ZTACKLES, ZHANDBALLS, ZMARKS, ZUSERNAME, ZLASTNAME, ZFIRSTNAME) values (9,16,1,9,0,0,0,0,0,0,'ot1@gmail.com','Ot1', 'Dude1');
insert into ZUSER (Z_PK, Z_ENT, Z_OPT, ZUSERID, ZGOALS, ZBEHINDS, ZKICKS, ZTACKLES, ZHANDBALLS, ZMARKS, ZUSERNAME, ZLASTNAME, ZFIRSTNAME) values (10,16,1,10,0,0,0,0,0,0,'ot2@gmail.com','Ot2', 'Dude2');
