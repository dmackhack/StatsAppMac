...
insert into ZUSER (Z_PK, Z_ENT, Z_OPT, ZID, ZGOALS, ZBEHINDS, ZKICKS, ZTACKLES, ZHANDBALLS, ZMARKS, ZUSERNAME, ZLASTNAME, ZFIRSTNAME) values (4,16,1,4,0,0,0,0,0,0,'mjamar@gmail.com','Mark', 'Jamar');
insert into ZUSER (Z_PK, Z_ENT, Z_OPT, ZID, ZGOALS, ZBEHINDS, ZKICKS, ZTACKLES, ZHANDBALLS, ZMARKS, ZUSERNAME, ZLASTNAME, ZFIRSTNAME) values (5,16,1,5,0,0,0,0,0,0,'xav1@gmail.com','Xav1', 'Dude1');
insert into ZUSER (Z_PK, Z_ENT, Z_OPT, ZID, ZGOALS, ZBEHINDS, ZKICKS, ZTACKLES, ZHANDBALLS, ZMARKS, ZUSERNAME, ZLASTNAME, ZFIRSTNAME) values (6,16,1,6,0,0,0,0,0,0,'xav2@gmail.com','Xav2', 'Dude2');
insert into ZUSER (Z_PK, Z_ENT, Z_OPT, ZID, ZGOALS, ZBEHINDS, ZKICKS, ZTACKLES, ZHANDBALLS, ZMARKS, ZUSERNAME, ZLASTNAME, ZFIRSTNAME) values (7,16,1,7,0,0,0,0,0,0,'om1@gmail.com','Om1', 'Dude1');
